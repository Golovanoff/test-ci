...
Процедура ДолженОбработатьКоммиты()  Экспорт
	...
	Ожидаем.Что(ЛогРепо, "В репо появился 1й тестовый коммит").Содержит("95b48fc");
	Ожидаем.Что(ЛогРепо, "В репо появился 2й тестовый коммит").Содержит("ea66ec5");
	Ожидаем.Что(ЛогРепо, "В репо появился 3й тестовый коммит").Содержит("fa3706f");
